...
# Generated on: Fri Apr 25 14:41:51 IST 2025 (Fri Apr 25 09:11:51 UTC 2025)
...
set logfile fv/calculator_fsm/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/calculator_fsm -revised fv_map
...
add_search_path /home/user/cadence/FOUNDRY/digital/45nm/dig/lib -library -both
read_library -liberty -both \
    /home/user/cadence/FOUNDRY/digital/45nm/dig/lib/slow.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  alu_fsm.v
elaborate_design -golden -root {calculator_fsm} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/calculator_fsm/fv_map.v.gz
elaborate_design -revised -root {calculator_fsm}
...
#add_name_alias fv/calculator_fsm/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.calculator_fsm.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.calculator_fsm.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.calculator_fsm.rtl.fv_map.rpt
